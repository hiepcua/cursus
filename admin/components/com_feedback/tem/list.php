...
$total_rows=SysCount('tbl_feedback',$strWhere);
$max_rows = 20;
				...
				<div class='row'>
					<div class='col-sm-3'>
						<div class='form-group'>
							<input type='text' id='txt_title' name='q' value="<?php echo $get_q;?>" class='form-control' placeholder="Email address..." />
						</div>
					</div>
				...
				<table class="table">
					...
					<tbody>
						...
						if($total_rows>0){
							...
							$obj=SysGetList('tbl_feedback',array(), $strWhere, false);
							$stt=0;
