...
<section class="content">
	<div class="container-fluid">
		<?php 
		if($isAdmin==1){
			$numberRoom=SysCountList('tbl_class',"");
			$numberMember=SysCountList('tbl_member',"");
			$numberMeeting=SysCountList('tbl_schedule',"");
			?>
			...
			<div class="row">
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-info">
						<div class="inner">
							<h3><?php echo number_format($numberRoom);?></h3>
							<p>Meeting rooms</p>
						</div>
						<div class="icon">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-danger">
						<div class="inner">
							<h3><?php echo number_format($numberMeeting);?></h3>
							<p>Meetings</p>
						</div>
						<div class="icon">
