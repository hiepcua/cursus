...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><?php echo LANG['COM_MEMBER']['PROFILE_TITLE'];?></h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>"><?php echo LANG['COM_MEMBER']['BRECUM_HOME'];?></a></li>
					<li class="breadcrumb-item active"><?php echo LANG['COM_MEMBER']['PROFILE_TITLE'];?></li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
					...
					<div class="col-sm-8 col-lg-9">
						<div class="box-tabs">
							...
							<ul class="nav nav-tabs">
								<li class="nav-item">
									<a class="nav-link active" data-toggle="tab" href="#info"><?php echo LANG['COM_MEMBER']['PROFILE_TITLE'];?></a>
								</li>
							</ul>
						</div>
							...
							<div class="tab-pane container-fluid active" id="info">
								<form id="frm_action" class="form" action="" method="post" enctype="multipart/form-data">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label><?php echo LANG['COM_MEMBER']['PROFILE_FRM_NAME'];?><small class="cred"> (*)</small><span id="err_firstname" class="mes-error"></span></label>
										...
										<div class="col-sm-6">
											<div class="form-group">
												<label><?php echo LANG['COM_MEMBER']['PROFILE_FRM_PHONE'];?></label>
										...
										<div class="col-sm-6">
											<div class="form-group">
												<label><?php echo LANG['COM_MEMBER']['PROFILE_FRM_EMAIL'];?></label>
										...
										<div class="col-sm-6">
											<div class="form-group">
												<h6><?php echo LANG['COM_MEMBER']['PROFILE_FRM_UPLOAD_PHOTO'];?></h6>
									...
									<div class="text-center toolbar">
										<input type="submit" name="cmdsave_tab1" id="cmdsave_tab1" class="save btn btn-success" value="<?php echo LANG['COM_MEMBER']['PROFILE_FRM_SAVE'];?>" class="btn btn-primary">
									</div>
								</form>
							</div>
						</div>
