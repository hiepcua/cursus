...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0 text-dark"><?php echo LANG['COM_CLASS']['VIEW_TITLE'];?></h1>
			</div><!-- /.col -->
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="<?php echo ROOTHOST;?>">Home</a></li>
					<li class="breadcrumb-item active"><a href="<?php echo ROOTHOST;?>class"><?php echo LANG['COM_CLASS']['TITLE_LIST'];?></a></li>
					<li class="breadcrumb-item active"><?php echo LANG['COM_CLASS']['VIEW_TITLE'];?></li>
				</ol>
			</div><!-- /.col -->
		</div><!-- /.row -->
	</div><!-- /.container-fluid -->
	...
	<?php if($totalRows<=0){ ?>
		...
		<div class="card">
			...
			<div class="card-body text-center">
				<a href='<?php echo ROOTHOST;?>class' class='btn btn-primary btn-lg'><?php echo LANG['COM_CLASS']['BACK_ROOM'];?></a>
			</div>
			<!-- /.card-body -->
				...
				<div class="row">
					<div class="col-sm-4 border-right">
						<div class="description-block">
							...
							<span class="description-text"><?php echo LANG['COM_CLASS']['VIEW_TAB_MEETING'];?></span>
						</div>
						<!-- /.description-block -->
					</div>
					<!-- /.col -->
					<div class="col-sm-4 border-right">
						<div class="description-block">
							...
							<span class="description-text"><?php echo LANG['COM_CLASS']['VIEW_TAB_MEMBER'];?></span>
						</div>
						<!-- /.description-block -->
					</div>
					<!-- /.col -->
					<div class="col-sm-4">
						<div class="description-block">
							...
							<span class="description-text"><?php echo LANG['COM_CLASS']['VIEW_TAB_PRODUCT'];?></span>
						</div>
						<!-- /.description-block -->
					</div>
					<!-- /.col -->
		...
		<div class="card card-tabs">
			<div class="card-header p-0 pt-1">
				<ul class="nav nav-tabs text-center" id="custom-tabs-two-tab" role="tablist">
					<li class="nav-item">
						<a class="nav-link active" id="custom-tabs-two-home-tab" data-toggle="pill" href="#room-schedule" role="tab" aria-controls="custom-tabs-two-home" aria-selected="true"><?php echo LANG['COM_CLASS']['VIEW_TAB_MEETING'];?></a>
					</li>
					<li class="nav-item">
						<a class="nav-link" id="custom-tabs-two-profile-tab" data-toggle="pill" href="#room-members" role="tab" aria-controls="custom-tabs-two-profile" aria-selected="false"><?php echo LANG['COM_CLASS']['VIEW_TAB_MEMBER'];?></a>
					</li>
				</ul>
			</div>
			<div class="card-body">
